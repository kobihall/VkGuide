...
void vkutil::blit_image_to_layer(VkCommandBuffer cmd, VkImage source, VkImage destination, uint32_t destinationLayer, VkExtent2D srcSize, VkExtent2D dstSize)
{
	VkImageBlit2 blitRegion { .sType = VK_STRUCTURE_TYPE_IMAGE_BLIT_2, .pNext = nullptr };
	...
	blitRegion.dstSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
	blitRegion.dstSubresource.baseArrayLayer = destinationLayer;
	blitRegion.dstSubresource.layerCount = 1;
	blitRegion.dstSubresource.mipLevel = 0;
