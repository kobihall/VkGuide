...
**Outside the numbered sequence:** `docs/plans/depth-of-field.md` — a short, human-oriented to-do for wiring up the CPU raytracer's aperture and focus distance, which the user is implementing by hand. Depends only on (2) and can be done any time.
